...
int main()
{
	...
	CrearCilindro(20, 1.0f);//índice 2 en MeshList  AGREGANDO SEGMENTOS (10 se ve bien)
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		/*
				...
				color = glm::vec3(0.2f, 0.2f, 0.2f); // gris más oscuro
				glUniform3fv(uniformColor, 1, glm::value_ptr(color));
				glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
				...
				// Guardar el estado actual de la cabina
				modelaux = model;
				//-------articulacion tercera llanta (izquierda atrás)
				model = glm::translate(model, glm::vec3(2.5f, 3.5f, 0.0f));
				//TECLA Y
				...
				// Guardar el estado actual de la cabina
				modelaux = model;
				//-------articulacion cuarta llanta (derecha atrás)
				model = glm::translate(model, glm::vec3(2.5f, 3.5f, -4.0f));
				//TECLA Y
		...
		*/
		...
		//-----Pie Izquierdo
				...
				//------- Articulacion 7 (Pie izquierdo, cubo pequeño)
		...
		//-----Pie Derecho
				...
				//------- Articulacion 9 (Pie izquierdo, cubo pequeño)
				model = glm::translate(model, glm::vec3(0.12f, 0.1f, 1.5f));
				// TECLA U
