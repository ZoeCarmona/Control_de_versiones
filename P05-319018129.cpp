...
Camera camera;
//Creando instancias separadas de cada parte del cuerpo
//Model Goddard_M;
Model Cuerpo;
Model Cofre;
...
int main()
{
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//Carro
		//-----------------Cuerpo
		color = glm::vec3(0.0f, 0.0f, 0.55f);
		model = glm::mat4(1.0);
		//model = glm::translate(model, glm::vec3(0.0f, 13.6f, 0.0f));
		model = glm::translate(model, glm::vec3(0.0f, 13.6f, mainWindow.getPosicionCarroZ()));
		modelcuerpo = model;
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		Cuerpo.RenderModel();
		//-----------------Cofre
		color = glm::vec3(0.0f, 0.0f, 0.65f);
		model = modelcuerpo;
		model = glm::translate(model, glm::vec3(-1.1f, 7.6f, 27.0f));  //26.5z
		...
		model = modelcuerpo;
		model = glm::translate(model, glm::vec3(-19.0f, -5.5f, 36.2f));  
		...
		color = glm::vec3(0.1f, 0.1f, 0.1f);
		model = modelcuerpo;
		model = glm::translate(model, glm::vec3(16.1f, -5.81f, 36.2f));
		//Tecla H adelante, Tecla J atrás
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion2()), glm::vec3(1.0f, 0.0f, 0.0f));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		color = glm::vec3(0.1f, 0.1f, 0.1f);
		model = modelcuerpo;
		model = glm::translate(model, glm::vec3(-19.0f, -5.5f, -41.2f));
		//Tecla H adelante, Tecla J atrás
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion2()), glm::vec3(1.0f, 0.0f, 0.0f));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		color = glm::vec3(0.1f, 0.1f, 0.1f);
		model = modelcuerpo;
		model = glm::translate(model, glm::vec3(16.1f, -5.81f, -41.2f));
		//Tecla H adelante, Tecla J atrás
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion2()), glm::vec3(1.0f, 0.0f, 0.0f));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
